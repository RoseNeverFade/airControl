...
public class DeltaRollFrag extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        LineDataSet dataSet = new LineDataSet(entries, "横滚角变化量"); // add entries to dataset
...
//        chart.getAxisLeft().setValueFormatter(new ValueOffsetFormatter(droneData.lngAnchor));
        ...
        chart.getDescription().setText("横滚角变化量曲线");
//        dataSet.setColor(...);
